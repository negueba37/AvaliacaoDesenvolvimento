...
begin
  ...
  .Close
  .SQLClear
  .SQLAdd('SELECT FIRST 15 CLIENTE.CODIGO,CLIENTE.CPF,VENDAS.DATAVENDA FROM VENDAS')
  ...
  .SQLAdd('    )')
  .SQLAdd('GROUP BY CLIENTE.CODIGO,CLIENTE.CPF,VENDAS.DATAVENDA')
  .SQLAdd('ORDER BY VENDAS.DATAVENDA')
  .Open
end;
